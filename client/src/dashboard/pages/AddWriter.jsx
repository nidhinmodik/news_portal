    ...
    <div className='bg-white rounded-md'>
      ...
      <div className='p-4'>
        <form onSubmit={submit}>
          ...
          <div className='mt-4'>
            <button className='px-3 py-[6px] bg-blue-500 rounded-sm text-white hover:bg-blue-600' ><button disabled={loader} className='px-3 py-[6px] bg-blue-500 rounded-sm text-white hover:bg-blue-600' >{loader ? 'Loading...' : 'Add Writer'}</button></button>
          </div>
        </form>
      </div>
    </div>
